...
if gatetype == 1
    savefnn = strcat('mouse',num2str(mouse_id),'_FOV',num2str(FOV),'_case_',case_id,'_OR_response_',num2str(rep_no),'.mat');
    savefign1 = strcat('figure_mouse',num2str(mouse_id),'_FOV',num2str(FOV),'_case_',case_id,'_OR_response_single_trial.fig');
    savefign2 = strcat('figure_mouse',num2str(mouse_id),'_FOV',num2str(FOV),'_case_',case_id,'_OR_response_CDaxis_',num2str(rep_no),'.fig');
elseif gatetype == 2
    savefnn = strcat('mouse',num2str(mouse_id),'_FOV',num2str(FOV),'_case_',case_id,'_AND_response_',num2str(rep_no),'.mat');
    savefign1 = strcat('figure_mouse',num2str(mouse_id),'_FOV',num2str(FOV),'_case_',case_id,'_AND_response_single_trial.fig');
    savefign2 = strcat('figure_mouse',num2str(mouse_id),'_FOV',num2str(FOV),'_case_',case_id,'_AND_response_CDaxis_',num2str(rep_no),'.fig');
end
...
for zzt = 1:rep_no
    for tt=1:no_se
        ...
        for zz=1:no_se
            ...
            % CD delay classifier performance using early response dF/F0
            ...
            CD_proj_r_DB_classifier_r_shuffle(tt,zz,zzt) = mean(temp_e);
            clear temp_e
...
for i=1:length(sessions)
    for t=1:rep_no
        ...
        axis_all{2,i}(t,:) = orthonormal_basis_r{i,t}(:,2);
        axis_all{3,i}(t,:) = orthonormal_basis_r{i,t}(:,3);
    end
end
...
save(savefnn,'cell_no','rep_no','shuffle_rep','decoder_r_r','CD_proj_r_test',...
    'dot_all','axis_all','dot_all2','dot_all3','orthonormal_basis_r')
